...
software_name_download_first = 'STBBRD'
software_name_download_second = 'ZongziTEK-Blackboard-Sticker'
software_format = 'zip'
software_icon = './icon/ZongziTEK_software.png'
software_info = '简介\n用于白板一体机的桌面部件，有小黑板（布置作业）、启动台、课程表'
software_author = 'ZongziTEK'
software_github = f'https://github.com/{software_name_download_first}/{software_name_download_second}'
software_bilibili = 'https://space.bilibili.com/472376649'
