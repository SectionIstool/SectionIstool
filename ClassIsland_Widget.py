...
software_name_download_first = 'ClassIsland'
software_name_download_second = 'ClassIsland'
software_format = 'zip'
software_icon = './icon/ClassIsland_software.svg'
software_info = '简介\nClassIsland 是一款适用于班级多媒体屏幕的课表信息显示工具，可以在 Windows 屏幕上显示各种信息。\n本应用的名字灵感源于 iOS 灵动岛（Dynamic Island）功能。\n可显示当天的课表、当前进行课程的信息，在上下课等重要时间点发出提醒，自选搭配音效、强调特效和语音增强提醒。'
software_author = 'HelloWRC'
software_github = f'https://github.com/{software_name_download_first}/{software_name_download_second}'
software_bilibili = 'https://space.bilibili.com/355897687'
...
class ClassIsland_Widget(QFrame):
