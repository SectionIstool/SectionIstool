...
software_name_download_first = 'Sticky-attention'
software_name_download_second = 'Sticky-attention'
software_format = 'exe'
software_icon = './icon/Sticky_attention_software.png'
software_info = '简介\nSticky-attention 是一款适用于 Windows 系统教室一体机的作业显示工具\n可以展示各科作业等信息，拥有着原版没有的功能。'
software_author = 'jizilin6732'
software_github = f'https://github.com/{software_name_download_first}/{software_name_download_second}'
software_bilibili = 'https://space.bilibili.com/3546750482647776'
...
class Sticky_attention_Widget(QFrame):
