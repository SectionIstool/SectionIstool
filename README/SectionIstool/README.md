...
- ❌ SectionIstool 本身功能
  - ❌ 软件(自动)更新功能
- ❌ 软件下载功能
  - ❌ SectionIstool  -->  旗下程序下载功能
  - ❌ SectionIstool  -->  旗下程序更新功能
  - ❌ SectionIstool  -->  软件卸载功能
  - ❌ 教学辅助软件/一体机软件  -->  下载功能
  - ❌ 教学辅助软件/一体机软件  -->  更新功能
  - ❌ 教学辅助软件/一体机软件  -->  卸载功能
- ❌ 设置
...
* [PyQt6](https://www.riverbankcomputing.com/static/Docs/PyQt6/introduction.html#pyqt6-components) The official Python module
...
<picture>
  <source
    ...
    srcset="
      https://api.star-history.com/svg?repos=SectionIstool/SectionIstool&type=Date&theme=dark
    "
  />
  <source
  ...
  <img
    ...
    src="https://api.star-history.com/svg?repos=SectionIstool/SectionIstool&type=Date&theme=dark"
  />
</picture>


## License
[![FOSSA Status](https://app.fossa.com/api/projects/git%2Bgithub.com%2Flzy98276%2FSectionIstool.svg?type=shield&issueType=security)](https://app.fossa.com/projects/git%2Bgithub.com%2Flzy98276%2FSectionIstool?ref=badge_shield&issueType=security)
