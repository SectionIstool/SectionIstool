...
software_name = 'Win10_Win11_ElectronClassSchedule'
software_name_download_first = 'EnderWolf006'
software_name_download_second = 'ElectronClassSchedule'
software_format = 'zip'
software_icon = './icon/ElectronClassSchedule_software.png'
software_info = '简介\n电子桌面课程表，可用于学校电子白板'
software_author = 'EnderWolf006'
software_github = f'https://github.com/{software_name_download_first}/{software_name_download_second}'
software_bilibili = 'https://space.bilibili.com/3494364340816031'
...
class ElectronClassSchedule_Widget(QFrame):
